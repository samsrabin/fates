...
This is the main implementation of the run_fates_py_tests script contained in the
parent directory
"""
...
import argparse
import logging
from fates import unit_testing
...
def _commandline_args(description):
    ...
    Note that run_fates_py_tests is not intended to be
