...
This has been tested with the `ctsm_pyib` conda environment. See the [CTSM documentation](https://escomp.github.io/CTSM/users_guide/using-clm-tools/using-ctsm-pylib.html) for details.
...
2. via `./run_fates_py_tests`

   You can specify various arguments to this; run `./run_fates_py_tests
...
You can run pylint on everything in the fates package with `make lint`.
