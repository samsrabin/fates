module SFFireWeatherMod
  ...
  subroutine UpdateData(this, temp_C, precip, rh, wind)
    !
    !  DESCRIPTION:
    !  Updates fire weather data
  ...
  subroutine UpdateRxfireBurnWindow(this, rxfire_switch, temp_up, &
    ...
    ! LOCAL VARIABLES
    real(r8) :: wind_speed_m_per_s  ! wind speed (m/s)
    ...
    wind_speed_m_per_s = this%wind / sec_per_min
    ...
    ws_check = (wind_speed_m_per_s - wind_low)*(wind_speed_m_per_s - wind_up)
