      ...
      siteloop: do s = 1,nsites
         ...
         patchloop: do while(associated(cpatch))
            ...
            hio_is_forest_pct10_si(io_si) = hio_is_forest_pct10_si(io_si) + cpatch%area * AREA_INV * &
               logical_to_real(is_patch_forest(cpatch%area, cpatch%total_tree_area, cpatch%livegrass, 0.1_r8))
            hio_is_forest_pct25_si(io_si) = hio_is_forest_pct25_si(io_si) + cpatch%area * AREA_INV * &
               logical_to_real(is_patch_forest(cpatch%area, cpatch%total_tree_area, cpatch%livegrass, 0.25_r8))
            hio_is_forest_pct50_si(io_si) = hio_is_forest_pct50_si(io_si) + cpatch%area * AREA_INV * &
               logical_to_real(is_patch_forest(cpatch%area, cpatch%total_tree_area, cpatch%livegrass, 0.5_r8))
            hio_is_forest_pct75_si(io_si) = hio_is_forest_pct75_si(io_si) + cpatch%area * AREA_INV * &
               logical_to_real(is_patch_forest(cpatch%area, cpatch%total_tree_area, cpatch%livegrass, 0.75_r8))
            hio_is_forest_pct90_si(io_si) = hio_is_forest_pct90_si(io_si) + cpatch%area * AREA_INV * &
               logical_to_real(is_patch_forest(cpatch%area, cpatch%total_tree_area, cpatch%livegrass, 0.9_r8))
            hio_is_forest_pct10_0grass_si(io_si) = hio_is_forest_pct10_0grass_si(io_si) + cpatch%area * AREA_INV * &
               logical_to_real(is_patch_forest(cpatch%area, cpatch%total_tree_area, cpatch%livegrass, 0.1_r8, grass_biomass_threshold=0._r8))
            hio_is_forest_pct25_0grass_si(io_si) = hio_is_forest_pct25_0grass_si(io_si) + cpatch%area * AREA_INV * &
               logical_to_real(is_patch_forest(cpatch%area, cpatch%total_tree_area, cpatch%livegrass, 0.25_r8, grass_biomass_threshold=0._r8))
            hio_is_forest_pct50_0grass_si(io_si) = hio_is_forest_pct50_0grass_si(io_si) + cpatch%area * AREA_INV * &
               logical_to_real(is_patch_forest(cpatch%area, cpatch%total_tree_area, cpatch%livegrass, 0.5_r8, grass_biomass_threshold=0._r8))
            hio_is_forest_pct75_0grass_si(io_si) = hio_is_forest_pct75_0grass_si(io_si) + cpatch%area * AREA_INV * &
               logical_to_real(is_patch_forest(cpatch%area, cpatch%total_tree_area, cpatch%livegrass, 0.75_r8, grass_biomass_threshold=0._r8))
            hio_is_forest_pct90_0grass_si(io_si) = hio_is_forest_pct90_0grass_si(io_si) + cpatch%area * AREA_INV * &
               logical_to_real(is_patch_forest(cpatch%area, cpatch%total_tree_area, cpatch%livegrass, 0.9_r8, grass_biomass_threshold=0._r8))
